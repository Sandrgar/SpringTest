...
public class UtenteController {
	...
	@PostMapping
	public UtenteEntity insertUtente(@RequestBody UtenteDto utenteDto) {
	...
	@PostMapping("/{id}")
	public UtenteEntity compraLibri (@PathVariable Long id, @RequestBody AcquistoDto acquistoDto) {
		return utenteService.compraLibri(id, acquistoDto);
	}
	...
	public void libriRegalati() {
		...
		for(Long id : idUtenti) {
			utenteService.compraLibri(id, a);
		}
			}
